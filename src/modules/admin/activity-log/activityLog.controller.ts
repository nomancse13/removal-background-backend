...
export class ActivityLogController {
  ...
  //   }
    ...
    @ApiBody({
      ...
      description:
        'How to insert log with body?... here is the example given below:',
      examples: {
        a: {
          summary: 'default',
          value: {} as unknown as CreateActivityLogDto,
        },
      },
    })
    @Post()
    async createLog(
      ...
      const data = await this.activityLogService.entryLog(createActivityLogDto, userPayload);
